...
package com.proyecto.service.imp;
...
public class RegistroServiceImpl implements RegistroService{
    ...
    public Model activar(Model model, String username, String clave) {
        ...
        if (usuario!=null) {
            ...
            model.addAttribute("titulo",
                    messageSource.getMessage("registro.activar",
                            null, Locale.getDefault()));
            model.addAttribute("mensaje",
                    messageSource.getMessage("registro.activar.error",
                            null,Locale.getDefault()));
        }
        return model;
    }
    ...
    public void activar(Usuario usuario, MultipartFile imagenFile) {
        ...
        if (!imagenFile.isEmpty()){
            ...
            usuario.setRutaImagen(firebaseStorageService.cargaImagen(
                    imagenFile, 
                    "usuarios", 
    ...
    @Override
    public Model crearUsuario(Model model, Usuario usuario) throws 
            MessagingException {
        String mensaje;
        if (!usuarioService.
